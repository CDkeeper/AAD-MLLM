...
OUTPUT_DIR="./work_dirs2/${DPO_CLEAN_NAME}_our_11_22"
...
DATA_PATH="/mnt/data1/chenda/codes/LLaVA-NeXT/final_dpo_11_21.yaml"
echo $DPO_RUN_NAME
...
deepspeed --master_port 30000 \
    --include localhost:0,1,2,5,6,7 \
    llava/train/train_dpo2.py \
